...
// StudentDAOimp aslinda Student SERVICE dir
/* 
...
//DAO old. göstergesi - veya REPO sinifi
@Repository
public class StudentDAOimp implements StudentDAO{
	...
	@Override
	@Transactional
	public void update(Student studentFORupdating) {

			em.merge(studentFORupdating);			//asil update özelligi budur
	...
	public int deleteALLstudents() {
		...
		int total_deletedRow = em.createQuery("DELETE FROM Student").executeUpdate();
			
		return total_deletedRow;
	}
